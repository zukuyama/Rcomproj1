...
void open_nc(int * fd, const char * port) // abre descriptor da port em modo O_NOCTTY
{
...
{
    /*
     ATRIBUICAO DE CONTROLO DE SINAIS DEVE SER FEITA AO INICIO DE UM MAIN
     */
